...
int main(void)
{
    ...
    Shader shader = LoadShader(TextFormat("resources/shaders/glsl%i/simpleLight.vs", GLSL_VERSION),
                               TextFormat("resources/shaders/glsl%i/simpleLight.fs", GLSL_VERSION));
    ...
    Light another = CreateLight(LIGHT_POINT, (Vector3){ 2, 2, -2 }, Vector3Zero(), WHITE, shader);
